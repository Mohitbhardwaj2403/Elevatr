      ...
      <div className="max-w-md w-full space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-xs text-blue-700 space-y-1">
            <li>• Free resume analysis and ATS scoring</li>
            <li>• Access to job matching algorithm</li>
            <li>• Basic interview preparation tools</li>
